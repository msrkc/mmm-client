        ...
        <div class="editInfo__content-firma">
          <div class="editInfo__content-firma_column" style="display:flex;flex-flow:column;">
            ...
            <div style="width:24rem;display:inline-flex;margin-bottom:1.5rem;">
              <multiselect
                ...
                v-model="formData.company_values"
          ...
          <div class="editInfo__content-firma_column" style="display:flex;flex-flow:column;">
            ...
            <div class="radios">
              <div
                class="radio"
                v-for="(coorp, index) in options.forms_of_cooperation"
                :key="index"
              >
                <input
                  :id="coorp.value"
                  type="checkbox"
                  :value="coorp.value"
                  v-model="formData.forms_of_cooperation"
                >
            ...
            <div class="toggle-input">
              ...
              <div class="editInfo__content-firma_social">
                ...
                <div class="social-input">
                  <img src="@/assets/img/form/cominfo/facebook.svg">
                  <input
                    class="normal"
                    type="text"
                    id="facebook"
                ...
                <div class="social-input">
                  <img src="@/assets/img/form/cominfo/instagram.svg">
                  <input
                    class="normal"
                    type="text"
                    id="instagram"
                ...
                <div class="social-input">
                  <img src="@/assets/img/form/cominfo/linkedin.svg">
                  <input
                    class="normal"
                    type="text"
                    id="linkedin"
                ...
                <div class="social-input">
                  <img src="@/assets/img/form/cominfo/twitter.svg">
                  <input
                    class="normal"
                    type="text"
                    id="twitter"
