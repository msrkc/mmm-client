      ...
      <div slot="contentAcc" class="editInfo__content">
        <div class="editInfo__content-it">
          <div class="editInfo__content-it_column">
            ...
            <multiselect
              id="technology_stack"
              v-model="formData.technology_stack"
              tag-placeholder="Add this as new tag"
              placeholder="Search or add a technology"
              label="label"
              track-by="value"
              :options="options.technology_stack"
              :multiple="true"
              :taggable="true"
            ...
            <multiselect
              id="technology_stack"
              v-model="formData.version_control_systems"
              tag-placeholder="Add this as new tag"
              placeholder="Search or add a technology"
              label="label"
              track-by="value"
              :options="options.version_control_systems"
              :multiple="true"
              :taggable="true"
              open-direction="bottom"
              style="margin-bottom:10rem"
            ...
            <div class="editInfo__content-it__row-toggle">
              <span class="editInfo__content-dark-text">Zespol QA w firmie</span>
              <div class="toggle">
                <label class="switch">
            ...
            <div class="editInfo__content-it__row-toggle">
              <span class="editInfo__content-dark-text">Zespoly interdyspclinaasdasd</span>
              <div class="toggle">
                <label class="switch">
            ...
            <div class="editInfo__content-it__row-toggle">
              <span class="editInfo__content-dark-text">Mozliwosc zmiany projektu w obrebie firmy</span>
              <div class="toggle">
                <label class="switch">
            ...
            <div class="editInfo__content-it__row-toggle">
              <span class="editInfo__content-dark-text">Okresowa Evaoulacja</span>
              <div class="toggle">
                <label class="switch">
            ...
            <div class="editInfo__content-it__row-toggle">
              <span class="editInfo__content-dark-text">Mozliwosc wbory narzedzi pracy</span>
              <div class="toggle">
                <label class="switch">
          ...
          <div class="editInfo__content-it_column">
            ...
            <multiselect
              id="technology_stack"
              v-model="formData.methodologies"
              tag-placeholder="Add this as new tag"
              placeholder="Search or add a technology"
              label="label"
              track-by="value"
